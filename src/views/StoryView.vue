...
tagMap.value.push(new Tag('green portal').add('color', 'green').add('icon', 'mdi-orbit'))
tagMap.value.push(new Tag('flamethrower').add('color', 'red').add('icon', 'mdi-fire'))
tagMap.value.push(new Tag('jetpack').add('color', 'warning').add('icon', 'mdi-rocket-launch'))
tagMap.value.push(new Tag('dude with a mohawk').add('color', 'text').add('icon', 'mdi-account-circle-outline'))
