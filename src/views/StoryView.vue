...
tagMap.value.push(new Tag('green portal').attribute('color', 'green').attribute('icon', 'mdi-orbit'))
tagMap.value.push(new Tag('flamethrower').attribute('color', 'red').attribute('icon', 'mdi-fire'))
tagMap.value.push(new Tag('jetpack').attribute('color', 'warning').attribute('icon', 'mdi-rocket-launch'))
tagMap.value.push(new Tag('dude with a mohawk').attribute('color', 'text').attribute('icon', 'mdi-account-circle-outline'))
